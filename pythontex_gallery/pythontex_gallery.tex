...
\usepackage[pygments=true]{pythontex}
...
But we don't have to typeset the code.  It can be hidden.\pyc{mystring=r'\footnotesize\textbf{This is a message from Python}'}  And then we can access it later:  \py{mystring}.
